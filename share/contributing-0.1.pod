...
Generally, B<you do not need Dist::Zilla to contribute patches>.  You do need
...
If there is a C<tidyall.ini> file, you can also install Code::TidyAll and run
C<tidyall> on a file or C<tidyall -a> to tidy all files.
